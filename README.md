...
MVP 五章（**1、8、42、60、81**）鋪完後，照互見往外接了兩批：
**4、6、39、40、48、57、66、76、78**，再加 **2、22、37、56**、**24、43、51、63**、
**11、25、33、64**、**5、16、32、38**、**9、29、45、67**、**14、21、41、52**、
**7、28、54、77**、**3、12、19、46**、**18、20、36、58**、**10、23、47、59**，
再加 **13、15、17、26、27、30、31、34、49、65** 與
**35、44、50、53、55、61、62、68、69**。目前 73 章，每一條互見錨點都指得到句。
...
| 章資料 | 🟡 73 / 81 章，白話皆待口述校稿（`meta.status = draft`） |
...
標題下的切換鈕可切「只看原文與通讀」——精簡模式只是加一個 `body.lean` 讓 CSS 把白話、註解、todo 收起來，DOM 不動，所以切回去不必重新載入；狀態記在 `localStorage`，換章與重新整理都保持。
